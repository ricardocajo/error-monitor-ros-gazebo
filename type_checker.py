...
def type_checker(
    ...
    if ctx is None:
        ...
        if len(node.args) == 4:
            ...
            return (
                "property",
                node.args[0] + " " + state_1 + ", " + state_2,
                is_event_1 or is_event_2,
            )
        if len(node.args) == 5:
            type_2, state_2, is_event_2 = type_checker(
                node.args[3], ctx, property_=node.args[0], line=node.args[1]
            ...
            return (
                "property",
                node.args[0] + " " + state_1 + ", " + state_2 + ", " + state_3,
                is_event_1 or is_event_2 or is_event_3,
            )
